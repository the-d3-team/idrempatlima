...
import yggdrasil from "../data/yggdrasil";
...
const Yggdrasil = () => {
  ...
  const yggdrasilList = yggdrasil.map((item) => {
    if (item) {
      return {
        ...item,
      };
              ...
              <header className="slot-content-header">
                <div className="slot-content-active">
                  <amp-img
                    ...
                    src={`../static/images/yggdrasil.svg`}
                  />
                  <div className="slot-content-title-games">Yggdrasil</div>
                </div>
              </header>
              <div className="slot-content">
                <div className="games-grid">
                  {yggdrasilList.map((gamelists, index) => (
...
Yggdrasil.getInitialProps = async () => {
  // fetch list of posts
