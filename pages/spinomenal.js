...
import spinomenal from "../data/spinomenal";
...
const Spinomenal = () => {
  ...
  const spinoList = spinomenal.map((item) => {
    if (item) {
      return {
        ...item,
      };
              ...
              <header className="slot-content-header">
                <div className="slot-content-active">
                  <amp-img
                    ...
                    src={`../static/images/spinomenal.svg`}
                  />
                  <div className="slot-content-title-games">Spinomenal</div>
                </div>
              </header>
              <div className="slot-content">
                <div className="games-grid">
                  {spinoList.map((gamelists, index) => (
...
Spinomenal.getInitialProps = async () => {
  // fetch list of posts
