...
import microgaming from "../data/microgaming";
...
const Microgaming = () => {
  ...
  const microList = microgaming.map((item) => {
    if (item) {
      return {
        ...item,
      };
              ...
              <header className="slot-content-header">
                <div className="slot-content-active">
                  <amp-img
                    ...
                    src={`../static/images/microgaming.svg`}
                  />
                  <div className="slot-content-title-games">Microgaming</div>
                </div>
              </header>
              <div className="slot-content">
                <div className="games-grid">
                  {microList.map((gamelists, index) => (
...
Microgaming.getInitialProps = async () => {
  // fetch list of posts
