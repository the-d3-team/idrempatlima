...
import habanero from "../data/habanero";
...
const Habanero = () => {
  ...
  const habaneroList = habanero.map((item) => {
    if (item) {
      return {
        ...item,
      };
              ...
              <header className="slot-content-header">
                <div className="slot-content-active">
                  <amp-img
                    ...
                    src={`../static/images/habanero.svg`}
                  />
                  <div className="slot-content-title-games">Habanero</div>
                </div>
              </header>
              <div className="slot-content">
                <div className="games-grid">
                  {habaneroList.map((gamelists, index) => (
...
Habanero.getInitialProps = async () => {
  // fetch list of posts
