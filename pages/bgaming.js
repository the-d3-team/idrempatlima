...
import bgaming from "../data/bgaming";
...
const Bgaming = () => {
  ...
  const bgamingList = bgaming.map((item) => {
    if (item) {
      return {
        ...item,
      };
              ...
              <header className="slot-content-header">
                <div className="slot-content-active">
                  <amp-img
                    ...
                    src={`../static/images/bgaming.svg`}
                  />
                  <div className="slot-content-title-games">Bgaming</div>
                </div>
              </header>
              <div className="slot-content">
                <div className="games-grid">
                  {bgamingList.map((gamelists, index) => (
