...
import pgsoft from "../data/pgsoft";
...
const Pgsoft = () => {
  ...
  const pgsoftList = pgsoft.map((item) => {
    if (item) {
      return {
        ...item,
      };
              ...
              <header className="slot-content-header">
                <div className="slot-content-active">
                  <amp-img
                    ...
                    src={`../static/images/pgsoft.svg`}
                  />
                  <div className="slot-content-title-games">PG Soft</div>
                </div>
              </header>
              <div className="slot-content">
                <div className="games-grid">
                  {pgsoftList.map((gamelists, index) => (
