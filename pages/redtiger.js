...
import redtiger from "../data/redtiger";
...
const Redtiger = () => {
  ...
  const redtigerList = redtiger.map((item) => {
    if (item) {
      return {
        ...item,
      };
              ...
              <header className="slot-content-header">
                <div className="slot-content-active">
                  <amp-img
                    ...
                    src={`../static/images/evolution-redtiger.svg`}
                  />
                  <div className="slot-content-title-games">Red Tiger</div>
                </div>
              </header>
              <div className="slot-content">
                <div className="games-grid">
                  {redtigerList.map((gamelists, index) => (
...
Redtiger.getInitialProps = async () => {
  // fetch list of posts
