...
import wearecasino from "../data/wearecasino";
...
const Wearecasino = () => {
  ...
  const wearecasinoList = wearecasino.map((item) => {
    if (item) {
      return {
        ...item,
      };
              ...
              <header className="slot-content-header">
                <div className="slot-content-active">
                  <amp-img
                    ...
                    height={32}
                    alt="WeAreCasino"
                    src={`../static/images/wearecasino.svg`}
                  />
                  <div className="slot-content-title-games">WeAreCasino</div>
                </div>
              </header>
              <div className="slot-content">
                <div className="games-grid">
                  {wearecasinoList.map((gamelists, index) => (
...
Wearecasino.getInitialProps = async () => {
  // fetch list of posts
