...
import idnslot from "../data/idnslot";
...
const Idnslot = () => {
  ...
  const idnList = idnslot.map((item) => {
    if (item) {
      return {
        ...item,
      };
              ...
              <header className="slot-content-header">
                <div className="slot-content-active">
                  <amp-img
                    ...
                    src={`../static/images/idnslot.svg`}
                  />
                  <div className="slot-content-title-games">IDN Slot</div>
                </div>
              </header>
              <div className="slot-content">
                <div className="games-grid">
                  {idnList.map((gamelists, index) => (
